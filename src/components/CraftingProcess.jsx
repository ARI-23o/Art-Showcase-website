            ...
            >
              <div>
                ...
                <div className="flex items-center justify-between mb-5">
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-artisan-cream group-hover:bg-artisan-terracotta-light flex items-center justify-center text-xl transition-colors">
                    {stepItem.icon}
                  </div>
                </div>
              ...
              <div className="pt-4 mt-4 border-t border-artisan-border/40 text-[11px] text-artisan-muted flex items-center justify-between">
                ...
                <span className="text-emerald-700 font-medium">100% Dedicated</span>
              </div>
            </div>
          ))}
        </div>
